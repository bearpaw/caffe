...
if nargin < 3
    protopath = '/home/wyang/Data/Code/pose/chen_nips14_full/external/my_models/lsp/lsp_deploy_conv_no_inputdim.prototxt';
end
if nargin < 4
    modelpath = '/home/wyang/Data/Code/iccv/chen-nips14-pose-dev/cache/lsp/fully_conv_net_by_net_surgery.caffemodel';
end
if nargin < 5
    rmean = 115;
end
...
% delete tmp protopath file
unix(['rm -rf ' protopath]);
% extract output
