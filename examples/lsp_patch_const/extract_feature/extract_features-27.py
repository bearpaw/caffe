...
top_k = 1
# extract parameters
prototxt = "/home/wyang/github/caffe/examples/lsp_patch_const/cache/train-27-Jan-2015/lsp-xianjie-train-test.prototxt"
model_prefix = "/home/wyang/Data/cache/caffe/LSP_P26_K17_patch/models/model-01-27/lsp-patch-train_iter_"  # remember to change the model path
layer = "fc6-conv5"
leveldb = "jan-27-2015" # remember to change date
batchsize = 100
batchnum = top_k*10
dim = 183
out_dir = leveldb + "-mat/"
...
# start iterations
model_idx = range(200000, 200001, 1000)
