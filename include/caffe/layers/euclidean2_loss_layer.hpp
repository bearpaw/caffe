#ifndef CAFFE_EUCLIDEAN2_LOSS_LAYER_HPP_
#define CAFFE_EUCLIDEAN2_LOSS_LAYER_HPP_
...
class Euclidean2LossLayer : public LossLayer<Dtype> {
 public:
  explicit Euclidean2LossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "Euclidean2Loss"; }
  /**
...
#endif  // CAFFE_EUCLIDEAN2_LOSS_LAYER_HPP_
